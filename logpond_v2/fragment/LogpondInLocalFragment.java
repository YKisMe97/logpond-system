...
import com.infocomm.logpond_v2.activity.LogpondInDetailsActivity;
...
public class LogpondInLocalFragment extends android.support.v4.app.Fragment implements  View.OnClickListener, View.OnLongClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent logpondInDetailsIntent = new Intent(getContext(), LogpondInDetailsActivity.class);
                startActivityForResult(logpondInDetailsIntent, DETAILS_REQUEST_CODE);
    ...
    private class QueryTask extends AsyncTask<Object, Void, ArrayList> {
        ...
        protected ArrayList doInBackground(Object... prop) {
            ...
            try {
                File privateLogpondDir = new File(FileManager.getPrivateDirPath(getContext()) + "/export_logpond_in");
                File publicLogpondDir = new File(FileManager.getPublicDirPath(getContext()) + "/export_logpond_in");
        ...
        protected void onPostExecute(ArrayList result) {
            try{
                ...
                if(errorMessage.length()>0){
                    ...
                    FileManager.removeTempFile(getContext(), "LOGPOND_IN.TXT");
                    // Success
                }else{
                    ...
                    if(FileManager.retrieveTextContentAsStringArrayFromTempFile(getContext(), "LOGPOND_IN.TXT") != null){
                        Object[] object = FileManager.retrieveTextContentAsStringArrayFromTempFile(getContext(), "LOGPOND_IN.TXT");
...
//                                .setNegativeButton(android.R.string.no, null).show();
                        ...
                        JSONObject jsonObject = (JSONObject) arrayList.get(getAdapterPosition());
                        Intent logpondInDetailsIntent = new Intent(getContext(), LogpondInDetailsActivity.class);
                        logpondInDetailsIntent.putExtra("data", jsonObject.toString());
                        logpondInDetailsIntent.putExtra("position", getAdapterPosition());
                        startActivityForResult(logpondInDetailsIntent, DETAILS_REQUEST_CODE);
                        getActivity().overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    }
                } catch (Exception e) {
