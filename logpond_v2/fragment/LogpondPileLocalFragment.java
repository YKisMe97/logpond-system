...
import com.infocomm.logpond_v2.activity.LogpondPileDetailsActivity;
...
public class LogpondPileLocalFragment extends android.support.v4.app.Fragment implements  View.OnClickListener, View.OnLongClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent logpondPileDetailsIntent = new Intent(getContext(), LogpondPileDetailsActivity.class);
                startActivityForResult(logpondPileDetailsIntent, DETAILS_REQUEST_CODE);
    ...
    private class QueryTask extends AsyncTask<Object, Void, ArrayList> {
        ...
        protected ArrayList doInBackground(Object... prop) {
            ...
            try {
                File privateLogpondDir = new File(FileManager.getPrivateDirPath(getContext()) + "/export_logpond_pile");
                File publicLogpondDir = new File(FileManager.getPublicDirPath(getContext()) + "/export_logpond_pile");

                if(!privateLogpondDir.exists()){
                    privateLogpondDir.mkdirs();
                }

                if(!publicLogpondDir.exists()){
                    publicLogpondDir.mkdirs();
                }

                File[] publicLogpondFiles = publicLogpondDir.listFiles();
        ...
        protected void onPostExecute(ArrayList result) {
            try{
                ...
                if(errorMessage.length()>0){
                    ...
                    FileManager.removeTempFile(getContext(), "LOGPOND_PILE.TXT");
                    // Success
                }else{
                    ...
                    if(FileManager.retrieveTextContentAsStringArrayFromTempFile(getContext(), "LOGPOND_PILE.TXT") != null){
                        Object[] object = FileManager.retrieveTextContentAsStringArrayFromTempFile(getContext(), "LOGPOND_PILE.TXT");
            ...
            public void onClick(View v) {
                try {
                    if (v == binImgeView) {
                        ...
                        Intent logpondPileDetailsIntent = new Intent(getContext(), LogpondPileDetailsActivity.class);
                        logpondPileDetailsIntent.putExtra("data", jsonObject.toString());
                        logpondPileDetailsIntent.putExtra("position", getAdapterPosition());
                        startActivityForResult(logpondPileDetailsIntent, DETAILS_REQUEST_CODE);
                        getActivity().overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    }
                } catch (Exception e) {
