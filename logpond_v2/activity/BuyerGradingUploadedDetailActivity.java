...
public class BuyerGradingUploadedDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText(R.string.buyer_grading1);
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        adapter = new CustomAdapter(null);
        recyclerView.setLayoutManager(new LinearLayoutManager(BuyerGradingUploadedDetailActivity.this));
        recyclerView.setHasFixedSize(true);
        recyclerView.addItemDecoration(new DividerItemDecoration(BuyerGradingUploadedDetailActivity.this, LinearLayoutManager.VERTICAL));
    ...
    private class QueryTask extends AsyncTask<Object, Void, ArrayList> {
        ...
        protected void onPreExecute (){
            //progressDialog.show();
            errorMessage = "";
            username = SharedPreferencesStorage.getStringValue(BuyerGradingUploadedDetailActivity.this, SharedPreferencesStorage.USERNAME);
        }

        protected ArrayList doInBackground(Object... prop) {
            ArrayList tempArrayList= new ArrayList();
            try {
                File privateBuyerGradingDir = new File(FileManager.getPrivateDirPath(BuyerGradingUploadedDetailActivity.this) + File.separator + getString(R.string.transfer_buyer_grading));
                //File publicBuyerGradingDir = new File(FileManager.getPublicDirPath(BuyerGradingUploadedDetailActivity.this) + "/transfer_forest");
        ...
        protected void onPostExecute(ArrayList result) {
            try{
                ...
                if(errorMessage.length()>0){
                    Toast.makeText(BuyerGradingUploadedDetailActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                    // Success
                }else{
                    arrayList = ArrayListSortingManager.sortJsonObject(result, "recordName", false);
                    //Toast.makeText(BuyerGradingUploadedDetailActivity.this, getString(R.string.done), Toast.LENGTH_LONG).show();
    ...
    public class CustomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_HEADER) {
                ...
                final View layoutView = LayoutInflater.from(BuyerGradingUploadedDetailActivity.this).inflate(R.layout.logpond_out_list_row, parent, false);
        ...
        public class ItemViewHolders extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                try {
                    if (v == binImgeView) {
                        new AlertDialog.Builder(BuyerGradingUploadedDetailActivity.this)
                        ...
                        JSONObject jsonObject = (JSONObject) arrayList.get(getAdapterPosition());
                        Intent buyerGradingDetailsIntent = new Intent(BuyerGradingUploadedDetailActivity.this, BuyerGradingDetailsActivity.class);
                        ...
                        BuyerGradingUploadedDetailActivity.this.overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
