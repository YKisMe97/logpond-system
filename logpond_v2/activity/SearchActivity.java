...
public class SearchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView labelNumberTextView, oldLabelTextView, motherLabelTextView, cnbEntryNoTextView, cnbTextView,
            ...
            exportVergunningTextView, licenseNoTextView, buyerRejectTextView, containerTextView, buyerAllocationTextView, kapRegNoTextView, searchLabelNo;
    private ImageView searchImageView;
    private EditText searchLabelNumberEditTextView;
    private ProgressDialog progressDialog;
    private String searchLabelNumber;
    ...
    private void searchLabel(){
       ...
       /* if(!searchLabelNumber.startsWith("NA-")) {
            searchLabelNumberEditTextView.setText("NA-" + searchLabelNumberEditTextView.getText().toString().toUpperCase());
            searchLabelNumber = "NA-" + searchLabelNumber;
        }*/
        searchLabelNo.setText(searchLabelNumber);
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final JSONObject jsonObject = SqlDatabase.queryInventoryDetailsByLabelNumber(activity, searchLabelNumber);
                    if(jsonObject.length()>0){
                        ...
                        */
                        ...
                        activity.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                TTSManager.sayText(SearchActivity.this, getString(R.string.label_no_not_found));
                                ...
                                warningAlertDialog.MyDialogWithYesNo(SearchActivity.this,getString(R.string.search),getString(R.string.label_no_not_found),delete_listener,null);
