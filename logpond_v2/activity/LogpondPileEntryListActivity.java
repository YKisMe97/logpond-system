...
public class LogpondPileEntryListActivity extends AppCompatActivity implements View.OnClickListener {

    private final int SCANNER_REQUEST_CODE = 99;
    private LogpondPileEntryListActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.logpond_pile));
    ...
    public void onBackPressed() {
        ...
        /*
            new AlertDialog.Builder(LogpondPileEntryListActivity.this)
...
//                    killActivity();
            ...
            customAlertDialog.MyDialogWithYesNo(LogpondPileEntryListActivity.this,getString(R.string.app_name), getString(R.string.do_you_want_to_save),save_listener,kill_listener);
        }else{
            killActivity();
        }
    ...
    public void onClick(View view) {
        if(view==scanImageView){
            ...
            customAlertDialog = new CustomAlertDialog();
            customAlertDialog.MyDialogWithYesNo(LogpondPileEntryListActivity.this, getString(R.string.app_name), getString(R.string.do_you_want_to_save),save_listener,null);
        ...
        public class ItemViewHolders extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                if(v == binImgeView){
                    ...
                    deleteAlertDialogs.MyDialogWithYesNo(LogpondPileEntryListActivity.this,getString(R.string.delete), getString(R.string.are_you_sure_to_delete),delete_listener,null);
                }
                else if (v == more_detail_itemView){
                    String labelNumber = (String) labelEntryArrayList.get(getAdapterPosition());
                    Intent entryDetailsIntent = new Intent(LogpondPileEntryListActivity.this, ViewLabelDetailActivity.class);
    ...
    private void addLabelNumber(String labelNumber){
        ...
        if(labelNumber.trim().length()<7){
            ...
            deleteAlertDialogs.MyDialogWithYesNo(LogpondPileEntryListActivity.this,"Warning!", getString(R.string.less_than_7_digits_error),delete_listener,null);
            return;
        }
        ...
        if(leftCount<=0){
            ...
            deleteAlertDialogs.MyDialogWithYesNo(LogpondPileEntryListActivity.this,getString(R.string.logpond_pile), getString(R.string.you_have_reach_maximum_entry)+"\n"+getString(R.string.save_and_create_a_new_record),delete_listener,null);
            return;
        }
