...
public class LogpondInUploadedDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText(R.string.logpond_in);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(LogpondInUploadedDetailActivity.this));
        recyclerView.setHasFixedSize(true);
        recyclerView.addItemDecoration(new DividerItemDecoration(LogpondInUploadedDetailActivity.this, LinearLayoutManager.VERTICAL));
    ...
    private class QueryTask extends AsyncTask<Object, Void, ArrayList> {
        ...
        protected void onPreExecute (){
            //progressDialog.show();
            errorMessage = "";
            username = SharedPreferencesStorage.getStringValue(LogpondInUploadedDetailActivity.this, SharedPreferencesStorage.USERNAME);
        }

        protected ArrayList doInBackground(Object... prop) {
            ArrayList tempArrayList= new ArrayList();
            try {
                File privateBuyerGradingDir = new File(FileManager.getPrivateDirPath(LogpondInUploadedDetailActivity.this) + File.separator + getString(R.string.transfer_logpond_in));
                //File publicBuyerGradingDir = new File(FileManager.getPublicDirPath(LogpondInUploadedDetailActivity.this) + "/transfer_forest");
        ...
        protected void onPostExecute(ArrayList result) {
            try{
                ...
                if(errorMessage.length()>0){
                    Toast.makeText(LogpondInUploadedDetailActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                    // Success
                }else{
                    arrayList = ArrayListSortingManager.sortJsonObject(result, "recordName", false);
                    //Toast.makeText(LogpondInUploadedDetailActivity.this, getString(R.string.done), Toast.LENGTH_LONG).show();
    ...
    public class CustomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_HEADER) {
                ...
                final View layoutView = LayoutInflater.from(LogpondInUploadedDetailActivity.this).inflate(R.layout.logpond_out_list_row, parent, false);
        ...
        public class ItemViewHolders extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                try {
                    if (v == binImgeView) {
                        new AlertDialog.Builder(LogpondInUploadedDetailActivity.this)
                        ...
                        JSONObject jsonObject = (JSONObject) arrayList.get(getAdapterPosition());
                        Intent buyerGradingDetailsIntent = new Intent(LogpondInUploadedDetailActivity.this, LogpondInDetailsActivity.class);
                        ...
                        LogpondInUploadedDetailActivity.this.overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
